use crate::direct_call::primitives::IMPError;
use crate::direct_call::primitives::Index;
use crate::direct_call::primitives::ShardIdentifier;
use crate::direct_call::primitives::SidechainBlockNumber;
use crate::direct_call::primitives::UserShieldingKeyType;
use crate::direct_call::primitives::VCMPError;
use crate::direct_call::top::TrustedOperation;
use crate::direct_call::types::AccountId;
use crate::direct_call::types::KeyPair;
use crate::direct_call::types::Signature;
use crate::primitives::assertion::Assertion;
use crate::primitives::identity::Identity;
use crate::primitives::identity::ValidationData;
use crate::primitives::Balance;
use crate::primitives::ChallengeCode;
...
impl TrustedCallSigned {
    ...
    pub fn verify_signature(&self, mrenclave: &[u8; 32], shard: &ShardIdentifier) -> bool {
        ...
        payload.append(&mut shard.encode());
        self.signature
            .verify(payload.as_slice(), self.call.sender_account())
    }
